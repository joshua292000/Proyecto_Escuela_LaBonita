              ...
              <div className="row ">
                  ...
                  <div className="col-sm  ">
                      <div className="field">
                          ...
                          <div >
                            <Calendar
                                className={requerido && !state.fechaNaci ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                          ...
                          <div>
                              <InputText
                                ...
                                onKeyDown={(event)=>compoSiguente(event, 3)}
                                  id="pApellido"
                                  className={requerido && !state.pApellido ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                          ...
                          <div>
                              <InputText
                                ...
                                onKeyDown={(event)=>compoSiguente(event,4)}
                                  id="sApellido"
                                  className={requerido && !state.sApellido ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                      ...
                      <div className="field">
                          ...
                          <div>
                              <Dropdown
                                  ...
                                  name="Provincia"
                                  id="Provincia"
                                  className={requerido && !state.provincia ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                      ...
                      <div className="field">
                          ...
                          <div>
                              <Dropdown
                                  inputId="dropdown"
                                  value={state.canton}
                                  className={requerido && !state.canton ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                                  name="Canton"
                                  id="Canton"
                                  placeholder="Cantón"
                                  optionValue="code"
                      ...
                      <div className="field">
                          ...
                          <div>
                              <Dropdown
                                  ...
                                  className={requerido && !state.distrito ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                                  options={Dis}
                                  onClickCapture={(e) =>
                                      Distrito.getDistrito().then(data => setDistrito(data.filter(data => data.pro === state.canton)))}
                  ...
                  <div className="col-sm ">
                      <InputTextarea
                       ...
                       onKeyDown={(event)=>compoSiguente(event, 5)}
                          className={requerido && !state.direccion ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                  ...
                  <div className="col-auto">
                      ...
                      <div>
                          <Dropdown
                              ...
                              id="lugarnacimiento"
                              className={requerido && !state.lugarNacimiento ? 'p-invalid'  : "p-inputtext-sm block mb-2"}
                              optionValue="name"
