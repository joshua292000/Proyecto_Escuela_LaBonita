...
const ConstanciaMatriculaPDF = (props) =>{
    ...
    return(
        ...
        <Page size="A4" style={styles.body}>
            ...
            <Text style={styles.text}>
              La suscrita M.Sc. {funcionario.map((func)=>{return func.PNombre +' '+func.SNombre+' '+func.PApellido+' '+func.SApellido})}, en calidad de directora del Centro Educativo Rodrigo
...
const styles = StyleSheet.create({
    ...
    export default ConstanciaMatriculaPDF; 